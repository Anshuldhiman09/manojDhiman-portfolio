...
function useSVGProps(props, visualState, _isStatic, Component2) {
  const visualProps = (0, import_react12.useMemo)(() => {
...
function useRender(Component2, props, ref, { latestValues }, isStatic, forwardMotionProps = false) {
  ...
  const elementProps = Component2 !== import_react13.Fragment ? { ...filteredProps, ...visualProps, ref } : {};
  const { children } = props;
  const renderedChildren = (0, import_react13.useMemo)(() => isMotionValue(children) ? children.get() : children, [children]);
  return (0, import_react13.createElement)(Component2, {
    ...elementProps,
...
function useVisualElement(Component2, visualState, props, createVisualElement, ProjectionNodeConstructor) {
  ...
  const reducedMotionConfig = (0, import_react15.useContext)(MotionConfigContext).reducedMotion;
  ...
  const wantsHandoff = (0, import_react15.useRef)(Boolean(optimisedAppearId) && !((_a = window.MotionHandoffIsComplete) == null ? void 0 : _a.call(window, optimisedAppearId)) && ((_b = window.MotionHasOptimisedAnimation) == null ? void 0 : _b.call(window, optimisedAppearId)));
...
function usePresence(subscribe = true) {
  ...
  const safeToRemove = (0, import_react17.useCallback)(() => subscribe && onExitComplete && onExitComplete(id3), [id3, onExitComplete, subscribe]);
...
function MeasureLayout(props) {
  ...
  return (0, import_jsx_runtime2.jsx)(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: (0, import_react19.useContext)(SwitchLayoutGroupContext), isPresent: isPresent2, safeToRemove });
}
...
//# sourceMappingURL=chunk-4OBZULHI.js.map
